...
public class LoginVista extends JFrame {
    ...
    public LoginVista() {
        ...
        Panel = new JPanel();
        UserE = new JLabel("NOMBRE DE USUARIO:");
        ...
        Entrar = new JButton();
        NuevoUser = new JButton("Registrar nuevo Usuario");
        Cerrar = new JButton();
        ...
        NuevoUser.setBackground(new Color(238, 112, 82));
        NuevoUser.setForeground(new Color(238, 112, 82));
        ...
        NuevoUser.addActionListener(
                (e) -> {
                    this.dispose();
                    AdminModelo mod = new AdminModelo();
                    AdminVista view = new AdminVista();
                    AdminControlador crt = new AdminControlador(view, mod);
                    crt.iniciar();
                }
        );
